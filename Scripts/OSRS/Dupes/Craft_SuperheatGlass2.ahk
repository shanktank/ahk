...
Class Target {
	...
	traceCoordsBounds() {
		Corners := [ [ This.targetCoordBounds[1], This.targetCoordBounds[2] ], [ This.targetCoordBounds[3], This.targetCoordBounds[2] ], [ This.targetCoordBounds[3], This.targetCoordBounds[4] ], [ This.targetCoordBounds[1], This.targetCoordBounds[4] ], [ This.targetCoordBounds[1], This.targetCoordBounds[2] ] ]
	...
	display() {
		MsgBox % This.targetname ": " This.clickCoords[1] ", " This.clickCoords[2] " " This.sleepTime " " This.mouseSpeed
	}
}
...
displayCoords(coords) {
    ...
    For index, element in coords {
		...
		MouseMove, element[1], element[2], 50
		Sleep, 1000
    }
...
traceAll() {
	for i2, e2 in targetList {
		e2.display()
		e2.traceCoordsBounds()
	}
}

;=================================================================================================;

Global cb := New ClickBounds()
Global targetList := []
...
F1::cb.doCycle()
F2::displayCoords(targetList[4].targetCoordBounds)
F3::targetList[4].traceCoordsBounds()
F4::traceAll()
