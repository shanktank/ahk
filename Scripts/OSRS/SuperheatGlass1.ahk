...
F1::cb.startCycle()
;F2::cb.testCoordBounds(cb.bankerCoordBounds)
F2::traceCoordsBounds([ cb.bankerCoordBounds[1], cb.bankerCoordBounds[2] ], [ cb.bankerCoordBounds[3], cb.bankerCoordBounds[4] ])
